...
class Invite
{
    ...
    {
	if (null === $uid) {
	    $this->_uid = uniqid(rand(0, getmypid())) . "@cokertire.com";
	} else {
	    $this->_uid = $uid . "@cokertire.com";
	}
    ...
    $save_title = preg_replace('/\s+/', '', $this->_name);
	...
	header("Content-Disposition: attachment; filename=\"$save_title.ics\"");
