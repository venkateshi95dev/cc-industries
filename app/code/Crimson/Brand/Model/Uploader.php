...
class Uploader
{
     ...
     * @var string
     */
    const IMAGE_TMP_PATH    = 'brand/tmp/images/image';
    /**
     * @var string
     */
    const IMAGE_PATH        = 'brand/images/image';
    /**
     * @var string
     */
    const FILE_TMP_PATH     = 'brand/tmp/images/file';
    /**
     * @var string
     */
    const FILE_PATH         = 'brand/images/file';
