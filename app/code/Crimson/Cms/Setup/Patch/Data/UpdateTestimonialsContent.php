...
class UpdateTestimonialsContent implements
    DataPatchInterface,
...
<script type="text/javascript">
    require([
        ...
        $blockcontent ='<p>{{widget type="Ves\Testimonial\Block\Widget\CustomWidget" widget_title="What Others Are Saying..." number_item="12" category="1" order_by="rating" layout="grid2" grid_column="3" grid_pagination="1" item_per_page="3" show_name="1" show_address="0" show_email="0" show_company="1" show_job="0" show_title="1" show_image="1" image_width="75" image_height="75" show_rating="0" show_socialnetworks="0" show_date="0" show_readmore="1" readmore_char="400" number_item_percolumn="1" large_max_items="3" large_items="3" portrait_items="3" tablet_items="3" tablet_small_items="3" mobile_items="1" autoplay="0" autoplay_hover_pause="0" dots="1" nav="0" rtl="0" loop="0" type_name="Ves Testimonial Widget"}}</p>';
