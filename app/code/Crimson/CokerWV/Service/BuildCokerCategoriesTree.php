...
class BuildCokerCategoriesTree
{
    const CSV_FILE_PATH = '/import/coker_zip_data_migration/coker_categories.csv';
    ...
    public function execute(): void
    {
        ...
        $this->emulation->startEnvironmentEmulation($cokerTireStoreId, \Magento\Framework\App\Area::AREA_FRONTEND, true);
    ...
    private function _initRootCategoryLevel()
    {
        ...
        if ($collection->getSize()) {
            ...
            $this->arrayCatCreated[1][CreateCokerCategory::COKER_ROOT_CATEGORY_NAME] = $rootCategoryId;
        }
    }
