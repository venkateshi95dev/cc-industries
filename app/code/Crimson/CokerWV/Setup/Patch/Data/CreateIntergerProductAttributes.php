...
class CreateIntergerProductAttributes implements DataPatchInterface
{
    const CSV_FILE_PATH = '/import/coker_zip_data_migration/coker_product_attributes_int.csv';
