...
class GenerateCokerWVNonDataRelatedConfig implements DataPatchInterface
{
    const CSV_FILE_PATH = '/import/coker_zip_data_migration/coker_nondata_extensions_config.csv';
