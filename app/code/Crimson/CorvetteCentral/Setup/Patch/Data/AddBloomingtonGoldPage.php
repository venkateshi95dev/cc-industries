...
class AddBloomingtonGoldPage implements DataPatchInterface
{
    const CMS_PAGE_TITLE = 'Bloomington Gold Corvette Show';
    const CMS_PAGE_ID = 'bloomingtongold';
    ...
    const CMS_PAGE_DATA_PATH = '/../../data/pages/bloomington-gold.html';
    const CMS_LAYOUT_UPDATE = 'full-width-with-left-sidebar';
    const CMS_TEMPLATE_META_TITLE = 'Bloomington Gold | Corvette Central';
