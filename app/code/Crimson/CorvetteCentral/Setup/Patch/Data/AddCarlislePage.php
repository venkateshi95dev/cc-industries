...
class AddCarlislePage implements DataPatchInterface
{
    const CMS_PAGE_TITLE = 'Corvettes at Carlisle';
    const CMS_PAGE_ID = 'carlisle';
    ...
    const CMS_PAGE_DATA_PATH = '/../../data/pages/carlisle.html';
    const CMS_LAYOUT_UPDATE = 'full-width-with-left-sidebar';
    const CMS_TEMPLATE_META_TITLE = 'Corvettes at Carlisle | Corvette Central';
    const CMS_TEMPLATE_META_DESCRIPTION = 'Corvette Central has had a long-standing relationship with Carlisle.';
