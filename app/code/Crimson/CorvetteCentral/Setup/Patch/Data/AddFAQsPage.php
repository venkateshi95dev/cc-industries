...
class AddFAQsPage implements DataPatchInterface
{
    const CMS_PAGE_TITLE = 'FAQ & Tutorials';
    const CMS_PAGE_ID = 'faqtutorials';
    ...
    const CMS_PAGE_DATA_PATH = '/../../data/pages/faqs.html';
    const CMS_LAYOUT_UPDATE = 'custom_cms_page';
    const CMS_TEMPLATE_META_TITLE = 'FAQ & Tutorials | Corvette Central';
    const CMS_TEMPLATE_META_DESCRIPTION = 'Read frequently asked questions and watch tutorial videos for the new Corvette Central website';
