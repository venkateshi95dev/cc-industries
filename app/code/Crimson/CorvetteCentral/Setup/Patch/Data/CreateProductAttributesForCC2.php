...
class CreateProductAttributesForCC2 implements DataPatchInterface
{
    ...
    public function apply()
    {
        ...
        $jsonFilePath = BP . '/app/code/Crimson/CorvetteCentral/Setup/data/product_attributes_2.json';
