...
class DisableDiscontinuedProductConfiguration implements DataPatchInterface
{
    ...
    public function apply(): void
    {
        try {
            ...
            $this->configWriter->save(\Crimson\Catalog\Model\Config::XPATH_DISABLE_DISCONTINUED, "1", ScopeInterface::SCOPE_WEBSITE, $ccWebsiteId);
            $this->configWriter->save(\Crimson\Catalog\Model\Config::XPATH_DISABLE_DISCONTINUED, "1", ScopeInterface::SCOPE_WEBSITES, $ccWebsiteId);
