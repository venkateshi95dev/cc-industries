...
class MakeAboutUsPageFullWidth implements DataPatchInterface
{
    const CMS_PAGE_TITLE = 'About Corvette Central';
    const CMS_PAGE_ID = 'history';
    ...
    const CMS_PAGE_DATA_PATH = '/../../data/pages/about-corvette-central-fullwidth.html';
    const CMS_LAYOUT_UPDATE = 'full-width-with-left-sidebar';
    const CMS_TEMPLATE_META_TITLE = 'History | Corvette Central';
    const CMS_TEMPLATE_META_DESCRIPTION = 'Learn how Jerry Kohn founded Corvette Central in 1975 and how this family-owned business grew in Sawyer, Michigan.';
