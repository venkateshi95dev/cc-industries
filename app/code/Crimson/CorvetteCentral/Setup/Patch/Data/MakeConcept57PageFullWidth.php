...
class MakeConcept57PageFullWidth implements DataPatchInterface
{
    const CMS_PAGE_TITLE = 'Concept 57';
    const CMS_PAGE_ID = 'concept_57';
    ...
    const CMS_PAGE_DATA_PATH = '/../../data/pages/concept-57-fullwidth.html';
    const CMS_LAYOUT_UPDATE = 'full-width-with-left-sidebar';
    const CMS_TEMPLATE_META_TITLE = 'Concept 57 | Corvette Central';
    const CMS_TEMPLATE_META_DESCRIPTION = 'Build a 1957 Corvette hot rod from the ground up with the Corvette Central kit';
