...
class MakeDiscountsMilitaryPageFullWidth implements DataPatchInterface
{
    const CMS_PAGE_TITLE = 'MILITARY DISCOUNT PROGRAM';
    const CMS_PAGE_ID = 'discount/military';
    ...
    const CMS_PAGE_DATA_PATH = '/../../data/pages/discounts-military-fullwidth.html';
    const CMS_PAGE_BANNER_PATH = '/../../data/cms-custom-banners/custom-banner-discounts-military.html';
    const CMS_LAYOUT_UPDATE = 'full-width-with-left-sidebar';
    const CMS_TEMPLATE_META_TITLE = 'Military Discount | Corvette Central';
