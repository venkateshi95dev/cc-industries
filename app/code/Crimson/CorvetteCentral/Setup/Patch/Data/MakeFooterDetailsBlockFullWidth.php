...
class MakeFooterDetailsBlockFullWidth implements DataPatchInterface
{
    const BLOCK_NAME = 'C. Central Footer Details';
    const BLOCK_ID = 'c_central-footer-details';
    const DATA_PATH = '/../../data/blocks/footer-details-fullwidth.html';
