...
class MakeGalleryPageFullWidth implements DataPatchInterface
{
    const CMS_PAGE_TITLE = 'Gallery';
    const CMS_PAGE_ID = 'gallery';
    ...
    const CMS_PAGE_DATA_PATH = '/../../data/pages/gallery-fullwidth.html';
    const CMS_LAYOUT_UPDATE = 'full-width-with-left-sidebar';
    const CMS_TEMPLATE_META_TITLE = 'Corvette Photo Gallery | Corvette Central';
    const CMS_TEMPLATE_META_DESCRIPTION = 'Customer photos, event highlights, wallpaper and other pictures of Corvettes';
