...
class MakeGrilleTeethUSAPageFullWidth implements DataPatchInterface
{
    const CMS_PAGE_TITLE = 'Grille Teeth USA';
    ...
    const CMS_PAGE_DATA_PATH = '/../../data/pages/grille-teeth-usa-fullwidth.html';
    const CMS_PAGE_BANNER_PATH = '/../../data/cms-custom-banners/custom-banner-grille-teeth-usa.html';
    const CMS_LAYOUT_UPDATE = 'full-width-with-left-sidebar';
    const CMS_TEMPLATE_META_TITLE = 'Grille Teeth USA | Corvette Central';
