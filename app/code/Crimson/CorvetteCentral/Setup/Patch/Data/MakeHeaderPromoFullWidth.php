...
class MakeHeaderPromoFullWidth implements DataPatchInterface
{
    const BLOCK_ID = 'c_central-header-offer';
    const BLOCK_NAME = 'C. Central PROMO/OFFERS';
    const DATA_PATH = '/../../data/blocks/header-offer-fullwidth.html';
