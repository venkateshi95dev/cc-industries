...
class MakePrivacyPolicyPageFullWidth implements DataPatchInterface
{
    const CMS_PAGE_TITLE = 'Privacy Policy';
    const CMS_PAGE_ID = 'privacy-policy';
    ...
    const CMS_PAGE_DATA_PATH = '/../../data/pages/privacy-policy-fullwidth.html';
    const CMS_LAYOUT_UPDATE = 'full-width-with-left-sidebar';
    const CMS_TEMPLATE_META_TITLE = 'Privacy Policies For Our Site';
    const CMS_TEMPLATE_META_DESCRIPTION = 'We value your trust very highly, and pledge to you, our customer, that we will work to protect the security and privacy of any personal information you provide to us.';
