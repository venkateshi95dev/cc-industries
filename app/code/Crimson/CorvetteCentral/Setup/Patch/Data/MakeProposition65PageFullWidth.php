...
class MakeProposition65PageFullWidth implements DataPatchInterface
{
    const CMS_PAGE_TITLE = 'About California Proposition 65 Warnings';
    const CMS_PAGE_ID = 'prop65';
    ...
    const CMS_PAGE_DATA_PATH = '/../../data/pages/prop65-fullwidth.html';
    const CMS_LAYOUT_UPDATE = 'full-width-with-left-sidebar';
    const CMS_TEMPLATE_META_TITLE = 'Proposition 65 Warnings | Corvette Central';
