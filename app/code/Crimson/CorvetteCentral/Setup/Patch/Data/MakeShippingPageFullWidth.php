...
class MakeShippingPageFullWidth implements DataPatchInterface
{
    const CMS_PAGE_TITLE = 'Shipping';
    const CMS_PAGE_ID = 'shipping-2';
    ...
    const CMS_PAGE_DATA_PATH = '/../../data/pages/shipping-fullwidth.html';
    const CMS_LAYOUT_UPDATE = 'full-width-with-left-sidebar';
    const CMS_TEMPLATE_META_TITLE = 'Shipping Policies | Corvette Central';
    const CMS_TEMPLATE_META_DESCRIPTION = 'Shipping policies and other information for Corvette Central orders';
