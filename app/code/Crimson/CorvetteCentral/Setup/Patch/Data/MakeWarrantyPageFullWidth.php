...
class MakeWarrantyPageFullWidth implements DataPatchInterface
{
    const CMS_PAGE_TITLE = 'Limited Warranty';
    const CMS_PAGE_ID = 'warranty';
    ...
    const CMS_PAGE_DATA_PATH = '/../../data/pages/warranty-fullwidth.html';
    const CMS_LAYOUT_UPDATE = 'full-width-with-left-sidebar';
    const CMS_TEMPLATE_META_TITLE = 'Warranty Policies | Corvette Central';
    const CMS_TEMPLATE_META_DESCRIPTION = 'Warranty and related product information for Corvette Central orders';
