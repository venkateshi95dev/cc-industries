...
class MakeWheelOffsetPageFullWidth implements DataPatchInterface
{
    const CMS_PAGE_TITLE = 'Corvette Wheel Size & Offset Chart';
    const CMS_PAGE_ID = 'wheel-offset';
    ...
    const CMS_PAGE_DATA_PATH = '/../../data/pages/wheel-offset-fullwidth.html';
    const CMS_LAYOUT_UPDATE = 'full-width-with-left-sidebar';
    const CMS_TEMPLATE_META_TITLE = 'Corvette Wheel Offset Calculator | Corvette Central';
    const CMS_TEMPLATE_META_DESCRIPTION = 'Determine the effect of changing your wheel width and offset';
