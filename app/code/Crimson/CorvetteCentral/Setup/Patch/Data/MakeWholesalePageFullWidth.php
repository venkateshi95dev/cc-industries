...
class MakeWholesalePageFullWidth implements DataPatchInterface
{
    const CMS_PAGE_TITLE = 'Dealer Wholesale Program';
    const CMS_PAGE_ID = 'wholesale';
    ...
    const CMS_PAGE_DATA_PATH = '/../../data/pages/wholesale-fullwidth.html';
    const CMS_PAGE_BANNER_PATH = '/../../data/cms-custom-banners/custom-banner-wholesale.html';
    const CMS_LAYOUT_UPDATE = 'full-width-with-left-sidebar';
    const CMS_TEMPLATE_META_TITLE = 'Wholesale | Corvette Central';
