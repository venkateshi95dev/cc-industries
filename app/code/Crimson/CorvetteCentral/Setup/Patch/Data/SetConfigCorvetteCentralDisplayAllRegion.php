...
class SetConfigCorvetteCentralDisplayAllRegion implements DataPatchInterface
{
    ...
    public function apply(): void
    {
        try {
            ...
            $this->configWriter->save('general/region/display_all', 0, ScopeInterface::SCOPE_WEBSITES, $ccWebsiteId);
