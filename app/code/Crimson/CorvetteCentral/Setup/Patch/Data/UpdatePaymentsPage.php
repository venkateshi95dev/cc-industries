...
class UpdatePaymentsPage implements DataPatchInterface
{
    ...
    const CMS_PAGE_DATA_PATH = '/../../data/pages/payment-page-updated.html';
    ...
    {
        return [
            MakePaymentMethodsPageFullWidth::class
        ];
    }
