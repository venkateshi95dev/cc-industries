...
class UpdateReturnPolicyPage implements DataPatchInterface
{
    ...
    const CMS_PAGE_DATA_PATH = '/../../data/pages/return-policy-with-titles-centered.html';
    ...
    {
        return [
            MakeReturnPolicyPageFullWidth::class
        ];
    }
