...
namespace Crimson\CorvetteCentralFlatRatePrepaid\Model\Carrier;

use Crimson\CorvetteCentralFlatRatePrepaid\Service\RequestService;
...
class FlatRatePrepaid extends AbstractCarrier implements CarrierInterface
{
    /**
     * @var string
     */
    protected $_code = 'flatrate_prepaid';
    ...
    public function collectRates(RateRequest $request)
    {
        ...
        if (!$this->requestService->isFullFlatRatePrepaidRequest($request)) {
            return false;
        }
