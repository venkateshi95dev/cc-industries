 ...
 * @date        01/25/2019
 */
namespace Crimson\Shipping\Block\Adminhtml\Shipping\Carrier\TablerateTwoday;

use Crimson\Shipping\Model\Carrier\Tableratetwoday;
use Crimson\Shipping\Model\ResourceModel\Carrier\Tableratetwoday\CollectionFactory;
...
/**
 * Class Grid
 * @package Crimson\Shipping\Block\Adminhtml\Shipping\Carrier\TablerateTwoday
 */
class Grid extends Extended
{
    ...
    {
        parent::_construct();
        $this->setId('shippingTwodayTablerateGrid');
