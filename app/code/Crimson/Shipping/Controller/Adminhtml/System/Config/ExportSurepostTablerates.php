...
use Crimson\Shipping\Block\Adminhtml\Shipping\Carrier\TablerateSurepost\Grid;
...
/**
 * Class ExportSurepostTablerates
 * @package Crimson\Shipping\Controller\Adminhtml\System\Config
 */
class ExportSurepostTablerates extends AbstractConfig
{
    /**
     * @var FileFactory
     */
    ...
    {
        $fileName = 'surepost_tablerates.csv';
        /** @var $gridBlock Grid */
