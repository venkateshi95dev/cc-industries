...
/**
 * Class Atypicalregions
 * @package Crimson\Shipping\Model\Carrier
 */
class Atypicalregions extends AbstractCarrier implements CarrierInterface
{

    /**
     * @var string
     */
    protected $_code = 'atypicalregions';
    ...
    private function createShippingMethod(): Method
    {
        ...
        $method->setCarrier('atypicalregions');
        $method->setCarrierTitle($this->getConfigData('title'));

        $method->setMethod('atypicalregions');
    ...
    {
        return ['atypicalregions' => $this->getConfigData('name')];
    }
