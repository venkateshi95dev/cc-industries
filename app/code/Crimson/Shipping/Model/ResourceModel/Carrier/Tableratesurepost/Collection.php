 ...
 * @date        01/24/2019
 */
namespace Crimson\Shipping\Model\ResourceModel\Carrier\Tableratesurepost;

use Magento\Framework\Model\ResourceModel\Db\Collection\AbstractCollection;

/**
 * Class Collection
 * @package Crimson\Shipping\Model\ResourceModel\Carrier\Tableratesurepost
 */
class Collection extends AbstractCollection
{
    ...
    {
        $this->_init(
            \Crimson\Shipping\Model\Carrier\Tableratesurepost::class,
            \Crimson\Shipping\Model\ResourceModel\Carrier\Tableratesurepost::class
        );
