...
class UpdateDesignRelatedProductAttributes20221115 implements DataPatchInterface
{
    ...
    { 
        ...
        $productAttributeDesignRelations['ships_from_manufacturer'] = AttributeDesignRelation::OPTION_INDIVIDUAL;
