...
namespace Crimson\ZipCokerWvConsolidation\Preference\Magento\Framework\Mail\Template;
...
class TransportBuilder extends \Magento\Framework\Mail\Template\TransportBuilder
{
    ...
    protected function prepareMessage()
    {
        ...
        $parts = $this->attachments ? array_merge([$mimePart], [$this->attachments]) : [$mimePart];
