...
class ExportPaymentHistoryCsv extends Action
{
     ...
     * Payment File Name
     *
     * @const PAYMENT_FILE_NAME
     */
    public const PAYMENT_FILE_NAME = "PaymentHistory.csv";
     ...
     * Execute
     *
     * Export customers most
     * ordered report to CSV format
     *
    ...
    public function execute()
    {
        ...
        /** @var $fileName */
        $fileName = self::PAYMENT_FILE_NAME;
        ...
        try {
            ...
            $this->ebizchargeLogger->addCritical(__(
                "Exception occured during exporting to CSV Erro: " . $e->getMessage()
            ));
        }
    }
}
