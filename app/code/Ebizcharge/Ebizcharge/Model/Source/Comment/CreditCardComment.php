 ...
 */
class CreditCardComment implements CommentInterface, CommentsInterface
{
    /**
     * @var TranApi
     */
    ...
    public function getCommentText($elementValue)
    {
        ...
        if (isset($paymentTypes['AllowCreditCardPayments']) && $paymentTypes['AllowCreditCardPayments'] !== false) {
            return __(str_replace("%s", self::EBIZCHARGE_API_PAYMENTS_CREDIT_CARD, self::EBIZCHARGE_API_YES_COMMENTS));
        }
    }
}
