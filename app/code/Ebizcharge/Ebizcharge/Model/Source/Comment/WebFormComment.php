...
/**
 * Web Form Comment Source Model
 *
 * Class WebFormComment
 */
class WebFormComment implements CommentInterface, CommentsInterface
{
    /**
     * @var TranApi
     */
    ...
    public function getCommentText($elementValue)
    {
        ...
        // phpcs:ignore
        return '<div class="message message-warning">' . __(str_replace("%s", self::EBIZCHARGE_API_YES_COMMENTS, self::EBIZCHARGE_API_NO_COMMENTS)) . '</div>';
    }
}
