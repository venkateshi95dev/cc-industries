 ...
 * Class Amount
 */
class ShippingAmountRenderer extends Column
{
    /**
     * @var Escaper
     */
    ...
    public function prepareDataSource(array $dataSource)
    {
        if (isset($dataSource['data']['items'])) {
            foreach ($dataSource['data']['items'] as & $item) {
                ...
                $totalAmount = strip_tags($this->getShippingAmount($totalAmount, $item));
     ...
     * @return string
     */
    public function getShippingAmount($price=0, $item = []): string
    {
