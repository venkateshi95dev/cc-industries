...
/**
 * Upcoming Subscriptions Customer Renderer
 *
...
class CustomerRenderer extends Column
{
    ...
    public function prepareDataSource(array $dataSource)
    {
        ...
        if (isset($dataSource['data']['items'])) {
            foreach ($dataSource['data']['items'] as & $item) {
                ...
                $item[$this->getData('name')] = $this->getLabelInfo($columnName, $customerEmail, $isEmail);
            }
        }
     ...
     * @return string
     */
    private function getLabelInfo($gridLabel, $customerEmail = null, $isEmail = false): string
    {
