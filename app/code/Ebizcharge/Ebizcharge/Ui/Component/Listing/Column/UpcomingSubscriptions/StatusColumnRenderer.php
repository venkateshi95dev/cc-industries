...
class StatusColumnRenderer extends Column
{
    ...
    private function getStatusHtml(int $status): string
    {
        ...
        switch ($status) {
            case FutureSubscriptionInterface::EBIZCHARGE_FUTURE_SUBSCRIPTION_STATUS_PENDING:
                $class = 'grid-severity-minor';
                $label = __(FutureSubscriptionInterface::EBIZCHARGE_FUTURE_SUBSCRIPTION_STATUS_PENDING_TITLE);
                break;
            case FutureSubscriptionInterface::EBIZCHARGE_FUTURE_SUBSCRIPTION_STATUS_COMPLETED:
                $class = 'grid-severity-notice';
                $label = __(FutureSubscriptionInterface::EBIZCHARGE_FUTURE_SUBSCRIPTION_STATUS_COMPLETED_TITLE);
                break;
            case FutureSubscriptionInterface::EBIZCHARGE_FUTURE_SUBSCRIPTION_STATUS_FAILED:
                $label = __(FutureSubscriptionInterface::EBIZCHARGE_FUTURE_SUBSCRIPTION_STATUS_FAILED_TITLE);
                break;
        }
