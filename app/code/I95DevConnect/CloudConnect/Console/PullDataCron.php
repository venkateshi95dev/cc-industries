 ...
 */
class PullDataCron extends CronBase
{
    /**
     * @inheritDoc
     */
    ...
    {
        $this->setName('i95devcron:pull-data');
        $this->setDescription('i95Dev Pull Data Cron');
        parent::configure();
    }
