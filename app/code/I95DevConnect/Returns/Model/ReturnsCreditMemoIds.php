...
namespace I95DevConnect\Returns\Model;

use Magento\Framework\Model\AbstractModel;

class ReturnsCreditMemoIds extends AbstractModel
{
    /**
    ...
    {
        $this->_init('I95DevConnect\Returns\Model\ResourceModel\ReturnsCreditMemoIds');
    }
}
