...
class Data extends AbstractHelper
{
    ...
    const UPS_USE_ACCESS_KEY       = 'iwd_addressvalidation/api_settings/use_ups_access_key';
    const UPS_USE_CLIENT_API_KEY   = 'iwd_addressvalidation/api_settings/ups_api_key';
    const UPS_USE_SECRET_KEY       = 'iwd_addressvalidation/api_settings/ups_secret_key';
    ...
    const USPS_API_KEY         = 'iwd_addressvalidation/api_settings/usps_api_key';
    const USPS_SECRET_KEY         = 'iwd_addressvalidation/api_settings/usps_secret_key';
    const USPS_NEW_KEY         = 'iwd_addressvalidation/api_settings/use_usps_account_id';
     ...
     * @return string
     */
    public function getNewAccessKey()
    {
        return $this->scopeConfig->getValue(self::UPS_USE_ACCESS_KEY, ScopeInterface::SCOPE_STORE);
    ...
    {
        return $this->scopeConfig->getValue(self::UPS_USE_CLIENT_API_KEY, ScopeInterface::SCOPE_STORE);
    }
    ...
    {
        return $this->scopeConfig->getValue(self::UPS_USE_SECRET_KEY, ScopeInterface::SCOPE_STORE);
    }
     ...
     * @return mixed
     */
    public function getUspsAPi()
    {
        return $this->scopeConfig->getValue(self::USPS_API_KEY, ScopeInterface::SCOPE_STORE);
    }

    /**
     * @return mixed
     */
    public function getUspsSecret()
    {
        return $this->scopeConfig->getValue(self::USPS_SECRET_KEY, ScopeInterface::SCOPE_STORE);
    }

    /**
     * @return mixed
     */
    public function getUspsApiType()
    {
        return $this->scopeConfig->getValue(self::USPS_NEW_KEY, ScopeInterface::SCOPE_STORE);
    }
