        ...
        return array(
            "XAVRequest" => array(
                "AddressKeyFormat" => array(
                    "AddressLine" => array(
                        $this->address['street'] ?? false
                    ),
                    "PoliticalDivision2" => $this->address['city'] ?? false,
                    "PoliticalDivision1" => $this->address['region_code'] ?? false,
                    "PostcodePrimaryLow" => $this->address['zip5'] ?? false,
                    "CountryCode" => $this->address['country_id'] ?? false
                )
            )
        );
    }
