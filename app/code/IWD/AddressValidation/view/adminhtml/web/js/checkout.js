...
function ($, modal, $t){
    ...
    $.widget('mage.iwdAddressValidationCheckout', {
        options: {
            ...
            formOrderShippingSameAsBillingId: '#order-shipping_same_as_billing',
        ...
        placeOrderButtonHasBeenClicked: false,
        ...
        init: function(options){
            ...
            document.addEventListener('totalsBlockReInit', function (e) {
                self.placeOrderButtonHasBeenClicked = false;
        ...
        onClickNextButton: function() {
            ...
            $(document).on('click touchstart', this.options.nextStepButtonId, (function(e) {
                ...
                if(self.validationBilling == true && self.validationShipping == true && !self.placeOrderButtonHasBeenClicked){
                    self.placeOrderButtonHasBeenClicked = true;
                    ...
                    if(window.AddressValidation && window.AddressValidation.type){
                        ...
                        $(self.options.nextStepButtonId).click();
                    }
                    return;
                }
        ...
        updateAddress:function(response, formId){
            ...
            if (checkedAddress.val() == 'origin'){
                self.validationBilling = true;
                self.validationShipping = true;
                this._isAddressValid();
                window.AddressValidation.type = 'origin';
                return true;
            }
        ...
        updateIsValidated: function(formId){
            ...
            if($('#order-shipping_same_as_billing:checked').length == 1 && this.validationBilling){
