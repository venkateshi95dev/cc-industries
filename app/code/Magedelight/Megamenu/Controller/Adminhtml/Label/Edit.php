...
class Edit extends \Magedelight\Megamenu\Controller\Adminhtml\Label
{
    ...
    public function execute()
    {
        ...
        $this->_coreRegistry->register('magedelight_megamenu_label', $model);
        ...
        $resultPage->getConfig()->getTitle()->prepend($model->getId() ? __('Edit Label %1', $model->getText()) : __('New Label'));
        return $resultPage;
    }
}
