...
class UpgradeSchema implements UpgradeSchemaInterface
{
    ...
    public function upgrade(SchemaSetupInterface $setup, ModuleContextInterface $context)
    {
        ...
        if (version_compare($context->getVersion(), '2.0.15', '<')) {
            $this->addExcludeCategoriesColumn($setup);
        }
    }
    ...
    protected function addExcludeCategoriesColumn(SchemaSetupInterface $setup)
    {
        $setup->getConnection()->addColumn(
            $setup->getTable('megamenu_menu_items'),
        ...
        $setup->getConnection()->addColumn(
            ...
            [
                ...
                'length' => 255,
                'nullable' => true,
                'comment' => 'Vertical Category Sort By',
                'after' => 'item_class'
            ]
        );
        $setup->getConnection()->addColumn(
            $setup->getTable('megamenu_menu_items'),
            'vertical_cat_sortorder',
            [
                'type' => \Magento\Framework\DB\Ddl\Table::TYPE_TEXT,
                'length' => 255,
                'nullable' => true,
                'comment' => 'Vertical Category Sort Order',
                'after' => 'item_class'
            ]
        );
        $setup->getConnection()->addColumn(
            ...
            [
                ...
                'length' => 255,
                'nullable' => true,
                'comment' => 'Vertical Child Category Level',
                'after' => 'item_class'
            ]
        );
    }
