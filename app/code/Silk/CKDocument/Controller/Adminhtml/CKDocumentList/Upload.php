...
{
    const UPLOAD_DIR = 'wysiwyg/document';

    const ADMIN_RESOURCE = 'Silk_CKDocument::save';

    protected $allowedExtension = ['jpeg','jpg','png','gif','pdf'];

    protected $mimeType = ['image/png', 'image/jpeg', 'image/gif','application/pdf'];
    /**
