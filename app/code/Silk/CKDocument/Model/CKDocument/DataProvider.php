<?php
namespace Silk\CKDocument\Model\CKDocument;

use Silk\CKDocument\Model\ResourceModel\CKDocument\CollectionFactory;
...
{
    /**
     * @var \Silk\CKDocument\Model\ResourceModel\CKDocument\Collection
     */
    ...
    public function getData()
    {
        ...
        /** @var \Silk\CKDocument\Model\CKDocument $document */
        foreach ($items as $document) {
            $this->loadedData[$document->getId()] = $this->revertData($document);
        }

        $data = $this->dataPersistor->get('cms_document');
        if (!empty($data)) {
