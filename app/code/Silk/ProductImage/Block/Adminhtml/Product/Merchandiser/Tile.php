...
class Tile extends \Magento\Backend\Block\Widget\Grid
{
     ...
     * @since 100.1.0
     */
    protected $_template = 'products/merchandiser/tile.phtml';
     ...
     * @param \Silk\ProductImage\Model\Products $products
    ...
    protected function _prepareCollection()
    {
        ...
        $productPositions = $this->_backendSession->getDocumentProductPositions(true);
    ...
    {
        return $this->getUrl('*/index/tile', ['_current' => true]);
    }
