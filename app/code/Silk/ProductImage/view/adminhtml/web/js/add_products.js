...
define([
    ...
    $.widget('mage.visualMerchandiserProductImageAddProducts', {
        options: {
            dialogUrl: null,
            dialogButton: null
        },
         ...
         */
        updateGrid: function () {
            this.registry.get('img_product_listing.img_product_listing_data_source').reload({
                refresh: true
            });
        },
        ...
        onGridLoad: function () {
            ...
            this.registry.get(
                'img_product_listing.img_product_listing_data_source',
        ...
        _save: function () {
            var idColumn = this
                .registry
                .get('img_product_listing.img_product_listing.img_product_columns.ids');
    ...
    return $.mage.visualMerchandiserProductImageAddProducts;
});
