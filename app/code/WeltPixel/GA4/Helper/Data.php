...
class Data extends \Magento\Framework\App\Helper\AbstractHelper
{
     ...
     * @var array
     */
    protected $_metaPixelOptions;

    /**
     * @var array
     */
    protected $_redditPixelOptions;

    /**
     * @var array
     */
    protected $_tiktokPixelOptions;
    /**
     * @var array
     */
    ...
    public function __construct(
        ...
        $this->_metaPixelOptions = $this->scopeConfig->getValue('weltpixel_ga4_meta_pixel', \Magento\Store\Model\ScopeInterface::SCOPE_STORE);
        $this->_redditPixelOptions = $this->scopeConfig->getValue('weltpixel_ga4_reddit_pixel', \Magento\Store\Model\ScopeInterface::SCOPE_STORE);
        $this->_tiktokPixelOptions = $this->scopeConfig->getValue('weltpixel_ga4_tiktok_pixel', \Magento\Store\Model\ScopeInterface::SCOPE_STORE);
    ...
    {
        $cookieRestrictionMode =  $this->scopeConfig->getValue(\Magento\Cookie\Helper\Cookie::XML_PATH_COOKIE_RESTRICTION, \Magento\Store\Model\ScopeInterface::SCOPE_STORE);
        if (empty($cookieRestrictionMode)) {
            return 0;
        }
    ...
    */
     ...
     * @return string
     */
    public function getAdsParentOrChildIdUsage()
    {
        return $this->_gtmOptions['adwords_conversion_tracking']['parent_vs_child'];
    }
     ...
     * @return boolean
     */
    public function loadDatalayerBeforeGtmContainer()
    {
        return $this->_gtmOptions['general']['load_datalayer_before_gtm'];
    }
     ...
     * @return string
     */
    public function getAffiliationNameByStore($storeId)
    {
     ...
     * @return boolean
     */
    public function preHashEnhancedConversion()
    {
        return $this->_gtmOptions['adwords_conversion_tracking']['prehash_enhanced_conversion'];
    }
    ...
    */
     ...
     * @return string
     */
    public function preHashCustomerData($customerData)
    {
        if (!$this->preHashEnhancedConversion()) {
            return $customerData;
        }
